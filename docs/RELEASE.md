...
| Field | Value | Source |
|---|---|---|
| Version | `0.3.5` | `Sources/MCPServer/MCPServer.swift` `serverVersion`, `package.json`, `.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json` |
...
SEMANTOUCH_REQUIRE_NOTARIZATION=1 scripts/verify-app-release dist/Semantouch.app 0.3.5
scripts/package-app-release dist/Semantouch.app dist 0.3.5 \
...
<key>CFBundleShortVersionString</key> <string>0.3.5</string>   <!-- match MCPServer.serverVersion -->
...
SEMANTOUCH_REQUIRE_NOTARIZATION=1 scripts/verify-app-release "Semantouch.app" "0.3.5"
...
xcrun stapler staple "Semantouch-v0.3.5-macos-universal2.dmg"
xcrun stapler validate "Semantouch-v0.3.5-macos-universal2.dmg"
```
